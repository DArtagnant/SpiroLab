...
def main(page: ft.Page):
    ...
    def switch_to_recorder(_):
        ...
        Paramètres :
            - _ : Un paramètre inutilisé (souvent utilisé pour des fonctions de rappel de flet).
        """
    ...
    def switch_to_showroom_page(_, audio_path):
        """
        Change la vue actuelle vers la page showroom (la chorégraphie visuelle) en fournissant un chemin audio.
        
        Paramètres :
            - _ : Un paramètre inutilisé (souvent utilisé pour des fonctions de rappel).
            - audio_path (str) : Le chemin vers le fichier audio à utiliser pour la chorégraphie.
        """
        page.views.clear()
